<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KLineHumAir.aspx.cs" Inherits="KLineHumAir" %>
...
<script type="text/javascript">
    ...
    // 开盘，收盘，最低，最高
    var myChart = echarts.init(document.getElementById('container'), 'infographic');
    var DATA = new Array;
    myChart.showLoading();//加载动画
    $.ajax({
        type: "post",   //请求的方法 
        url: "ajax/KLineHumAir.ashx",
        cache: false,
