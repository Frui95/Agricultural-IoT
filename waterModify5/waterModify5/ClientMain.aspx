<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SuperMain.aspx.cs" Inherits="SuperMain" %>
...
<body style="width: 100%;height:auto; background-color: #BDBDBD;overflow :scroll;margin:0px;padding:0px;">
    ...
    <div style="width:100%;height:100%;" >
        ...
        <%--<div><ul><li><a name="addinfor.aspx">添加井盖信息</a></li></ul></div> 
        <div><ul><li><a name="wellsearch.aspx">井盖信息查询</a></li></ul></div>
        <div><ul><li><a name="levelsearch.aspx">液位信息查询</a></li></ul></div>--
       <%-- <div "a href="addinfor.aspx">添加井盖信息</div>
        <div "a href="wellsearch.aspx">井盖信息查询</div>
        <div "a href="levelsearch.aspx">液位信息查询</div>--
       

        <div><li><a name="addinfor.aspx">添加井盖信息</a></li></div> 
        <div><li><a name="wellsearch.aspx">井盖信息查询</a></li></div>
        <div><li><a name="levelsearch.aspx">液位信息查询</a></li></div>
     
    </div>--%>
            <%--<div id="mm2" style="width:150px;">
        <%--<div "a href="sortByMode.aspx">按模块出现异常统计</div>
        <div "a href="sortByType.aspx">按模块类型统计</div>
        <div "a href="sortByTime.aspx">按丢失时间统计</div>
         <div "a href="levelsearch.aspx">按液位信息统计</div>--%>

            <%--<div><li><a name="sortByMode.aspx">按模块出现异常统计</a></li></div> 
        <div><li><a name="sortByType.aspx">按模块类型统计</a></li></div>
        <%--<div><li><a name="sortByTime.aspx">按丢失时间统计</a></li></div>--
        <div><li><a name="testSortByTime.aspx">按丢失时间统计</a></li></div>
        <div><li><a name="testLevel.aspx">按液位信息统计</a></li></div>

    </div>

      <div id="mm3" style="width:150px;">
     
        <div><li><a name="roleManage.aspx">用户信息管理</a></li></div>
    </div>--%>
    ...
    <div class="submenu">
        ...
        <li><a name="Reset.aspx">异常井盖复位</a></li>
                ...
                <div id="youbian" data-options="region:'center'" style="overflow:hidden">
                    <iframe id="mainiframe" name="iframe_a" src="地图OverLay.aspx" style="border-style: none; border-color: inherit; border-width: medium; width:100%; height:100%; margin-left:0px;" marginheight='0' marginwidth='0' scrolling="no"></iframe>
                </div>
