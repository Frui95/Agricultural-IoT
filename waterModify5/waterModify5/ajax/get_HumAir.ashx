<%@ WebHandler Language="C#" Class="get_HumAir" %>
...
public class get_HumAir : IHttpHandler {
    string nodes_id = "";
    ...
    public DataTable CreateDataTable()
    {
        ...
        //string comStr = "select time,airhum from greenhouse_info where nodes_id='" + nodes_id + "'";
        string comStr = "select airhum,CONVERT(VARCHAR(10),time,108) as time from greenhouse_info where convert(varchar(10),time,120)=convert(varchar(10),getdate(),120) and nodes_id='" + nodes_id + "'";
