<%@ WebHandler Language="C#" Class="get_airtemper" %>
...
public class get_airtemper : IHttpHandler {
    string nodes_id = "";
    ...
    public DataTable CreateDataTable()
    {
        ...
        //if (context.Request.QueryString["nodes_id"] != null) { nodes_id = Request.QueryString["nodes_id"].ToString(); }
        ...
        string comStr = "select airtemper,CONVERT(VARCHAR(10),time,108) as time from greenhouse_info where convert(varchar(10),time,120)=convert(varchar(10),getdate(),120) and nodes_id='" + nodes_id + "'";
        //string comStr = "select airtemper,CONVERT(VARCHAR(10),time,108) as time from greenhouse_info where convert(varchar(10),time,120)=convert(varchar(10),getdate(),120) and nodes_id=3";
