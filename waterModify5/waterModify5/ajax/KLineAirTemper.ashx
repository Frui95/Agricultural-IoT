<%@ WebHandler Language="C#" Class="KLineAirTemper" %>
...
public class KLineAirTemper : IHttpHandler {
    ...
    public DataTable CreateDataTable()
    {
        ...
        string comStr = "select 日期,Open_Airtemper,Close_Airtemper,Min_Airtemper,Max_Airtemper,avg from K_Line_Temperature";
