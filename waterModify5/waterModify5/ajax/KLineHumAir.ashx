<%@ WebHandler Language="C#" Class="KLineHumAir" %>
...
public class KLineHumAir : IHttpHandler {
    ...
    public DataTable CreateDataTable()
    {
        ...
        string comStr = "select 日期,Open_Hum,Close_Hum,Min_Hum,Max_Hum ,avg from K_Line_Hum_Air";
