<%@ WebHandler Language="C#" Class="get_Light" %>
...
public class get_Light : IHttpHandler {
    string nodes_id = "";
    ...
    public DataTable CreateDataTable()
    {
        ...
        //string comStr = "select time,light from greenhouse_info where nodes_id='" + nodes_id + "'";
        string comStr = "select light,CONVERT(VARCHAR(10),time,108) as time from greenhouse_info where convert(varchar(10),time,120)=convert(varchar(10),getdate(),120) and nodes_id='" + nodes_id + "'";
