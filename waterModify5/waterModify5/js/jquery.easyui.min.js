...
},afterPageText:"/ {pages}",displayMsg:"第 {from}  项,共 {total} 项"};
})(jQuery);
(function($){
function _93(_94){
var _95=$(_94);
...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"此项不能为空.",invalidMessage:null,rules:{email:{validator:function(_39c){
...
},message:"请输入有效的邮箱格式."},url:{validator:function(_39d){
...
},message:"请输入有效的URL格式."},length:{validator:function(_39e,_39f){
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{frozenColumns:undefined,columns:undefined,fitColumns:false,autoRowHeight:true,toolbar:null,striped:false,method:"get",nowrap:true,idField:null,url:null,loadMsg:"加载中 ...",rownumbers:false,singleSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowStyler:function(_5e5,_5e6){
