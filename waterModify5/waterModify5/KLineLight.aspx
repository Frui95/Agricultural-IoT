<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KLineLight.aspx.cs" Inherits="KLineLight" %>
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var i = 0; i < jsonD.length; i++) {
                ...
                //var date = jsonD[i]['日期'];
                var Open_Light = jsonD[i]['Open_Light'];
                var Close_Light = jsonD[i]['Close_Light'];
                var Min_Light = jsonD[i]['Min_Light'];
                var Max_Light = jsonD[i]['Max_Light'];
                var avg = jsonD[i]['avg'];
                var Light = new Array;
                Light[0] = dateT;
                Light[1] = Open_Light;
